...
/**
 * Scrolling game using the Tiled map editor @ http://www.mapeditor.org
 */
public class Scroller extends BasicGame {
    ...
    public void init(GameContainer container) throws SlickException {
        ...
        SpriteSheet sheet = new SpriteSheet("scroller/sprites.png", 32, 32);
        // load the tilemap created the TileD tool
        map = new TiledMap("scroller/map.tmx");
